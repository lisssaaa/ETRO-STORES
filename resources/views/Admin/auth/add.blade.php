        ...
        <div class="row mt"> 
         <div class="col-md-12"> 
          <div class="content-panel"> 
           <h4><i class="fa fa-angle-right"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 添加权限</font></font></h4> 
           <hr />
           <form class="form-horizontal style-form" action="/adminauths" method="post">
                {{csrf_field()}}
