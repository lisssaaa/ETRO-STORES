        ...
        <div class="row mt"> 
         <div class="col-md-12"> 
          <div class="content-panel"> 
           <h4><i class="fa fa-angle-right"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 添加角色</font></font></h4> 
           <hr />
           <form class="form-horizontal style-form" action="/adminroles" method="post">
                {{csrf_field()}}
                ...
                <div class="form-group">
                  <label class="col-sm-1 col-sm-1 col-sm-offset-1 control-label"><font style="vertical-align: inherit;">角色状态：</font></label>
                  <div class="col-sm-6">
