        ...
        <div class="row mt"> 
         <div class="col-md-12"> 
          <div class="content-panel"> 
           <h4><i class="fa fa-angle-right"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 分配权限</font></font></h4> 
           <hr />        
           
           <form class="form-horizontal style-form" action="/saveauth/{{$info->id}}" method="post">
                {{csrf_field()}}  
                <div class="form-group">
                    <label class="col-sm-1 col-sm-1 col-sm-offset-1 control-label"><font style="vertical-align: inherit;">角色名：</font></label>
                    <div class="col-sm-6">
                    <input type="text" value="{{$info->name}}" class="form-control" disabled>
                    </div>
                </div>              
                <div class="form-group">
                  <label class="col-sm-1 col-sm-1 col-sm-offset-1 control-label"><font style="vertical-align: inherit;">权限：</font></label>
                      ...
                      <div style="height:300px; overflow:auto;">
                        ...
                        <ul id="sortable" class="task-list ui-sortable"> 
                          ...
                          <li class="list-warning"> <i class=" fa fa-ellipsis-v"></i> 
                             <div class="task-checkbox"> 
                              <input type="checkbox" class="list-child" name="nid[]" value="{{$row->id}}" @if(in_array($row->id,$nid)) checked @endif />&nbsp;&nbsp;&nbsp;
                              <span class="task-title-sp">{{$row->name}}</span>
                             </div>                              
                           </li>
                           @endforeach 
                        </ul> 
                       ...
                       <div class="btn-group btn-group-xs">                                
                          <a class="btn btn-group btn-default all">全选</a> 
                          <a class="btn btn-group btn-default turn">反选</a>
                      </div> 
                      </div>                       
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a type="button" href="/adminroles" class="btn btn-default">取消</a>
                  </div>
                </div>                      
