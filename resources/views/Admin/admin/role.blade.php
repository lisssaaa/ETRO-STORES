        ...
        <div class="row mt"> 
         <div class="col-md-12"> 
          <div class="content-panel"> 
           <h4><i class="fa fa-angle-right"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 分配角色</font></font></h4> 
           <hr />        
           
           <form class="form-horizontal style-form" action="/saverole/{{$info->id}}" method="post">
                {{csrf_field()}}  
                <div class="form-group">
                    <label class="col-sm-1 col-sm-1 col-sm-offset-1 control-label"><font style="vertical-align: inherit;">管理员：</font></label>
                    <div class="col-sm-6">
                    <input type="text" value="{{$info->name}}" class="form-control" disabled>
                    </div>
                </div>              
                <div class="form-group">
                  <label class="col-sm-1 col-sm-1 col-sm-offset-1 control-label"><font style="vertical-align: inherit;">角色：</font></label>
                  <div class="col-sm-6">
                      
                      <!-- 角色表数据-->
                      @foreach($role as $row)                      
                       <label class="checkbox-inline">
                          <input type="checkbox" name="rid[]" value="{{$row->id}}" @if(in_array($row->id,$rid)) checked @endif> {{$row->name}}<br/>
                        </label>
                      @endforeach 
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a type="button" href="/adminusers" class="btn btn-default">取消</a>
                  </div>
                </div>                      
